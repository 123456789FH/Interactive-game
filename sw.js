const CACHE='place-value-treasure-v2-3-integrated-values';
const ASSETS=['./','./index.html','./styles.css','./game.js','./manifest.webmanifest','./assets/treasure-bg.png','./assets/icon-192.png','./assets/icon-512.png'];
